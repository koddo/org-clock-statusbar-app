...
I use org-mode and track my time. I used to forget to clock in, this tiny app solves the issue. And it helps a bit against procrastination hurrying me with the reddest color my monitor can display.
